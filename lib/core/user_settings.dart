...
class UserSettings {
  ...
  Future<void> saveCloud() async {
    ...
    settingsVersion += 1; // bump version on each save
  ...
  /// Reset to defaults (production: saves to local + cloud)
  ...
  /// Reset to defaults (test-friendly, synchronous, no async storage)
  void resetForTest() {
    final defaults = UserSettings.defaults();
    notificationsEnabled = defaults.notificationsEnabled;
    darkModeEnabled = defaults.darkModeEnabled;
