...
class _ConnectionsPageState extends State<ConnectionsPage> {
  ...
  Widget _buildUserStream(String? currentUid) {
    ...
    if (_selectedRegion != null)
      q = q.where('region', isEqualTo: _selectedRegion);
    // Note: ensure lower-case fields exist in lookup if you want to search by language/sex
    if (_selectedLanguage != null)
      q = q.where('language', isEqualTo: _selectedLanguage);
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        final docs =
            snapshot.data?.docs.where((d) => d.id != currentUid).toList() ?? [];
  ...
  Widget _buildEmptyState() {
    return const SliverFillRemaining(
      ...
      child: Center(
        child: Text(
          "No identity matches found in this sector.",
