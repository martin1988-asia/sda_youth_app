      ...
      children: List.generate(5, (index) {
        ...
        return IconButton(
          icon: Icon(
            ...
            color: active ? accentYellow : Colors.white12,
            size: 32,
          ),
      ...
      child: Row(
        children: [
          Icon(
            ...
            color: _isAnonymous ? electricTeal : Colors.white12,
            size: 18,
          ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Text(
                        data['sector']?.toUpperCase() ?? 'GENERAL',
                        style: const TextStyle(
                          color: electricTeal,
                          fontSize: 9,
                          fontWeight: FontWeight.w900,
    ...
    return Row(
      children: List.generate(
        ...
        (i) => Icon(
          Icons.star_rounded,
          size: 12,
          color: i < count ? accentYellow : Colors.white10,
        ),
      ),
    );
  }
