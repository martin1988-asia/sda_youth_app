                              ...
                              child: Column(
                                children: [
                                  _buildSector("Network Intelligence", [
                                    _switchTile(
                                      "Optimize Bandwidth",
                                      "Compress system data transfers",
                                      _optimizeBandwidth,
                                      (v) => setState(
                                        () => _optimizeBandwidth = v,
                                      ),
                                    ),
                                    _switchTile(
                                      "Reduce Sync Frequency",
                                      "Update cloud ledger less often",
                                      _reduceSyncFrequency,
                                      (v) => setState(
                                        () => _reduceSyncFrequency = v,
                                      ),
                                    ),
                                  ]),
                                  ...
                                  _buildSector("Media Consumption", [
                                    _switchTile(
                                      ...
                                      "Limit media to high-speed networks",
                                      _limitMediaDownloads,
                                      (v) => setState(
                                        () => _limitMediaDownloads = v,
                                      ),
                                    ),
                                    _switchTile(
                                      "Efficient Resolution",
                                      "Use lower quality visual assets",
                                      _lowQualityImages,
                                      (v) =>
                                          setState(() => _lowQualityImages = v),
                                    ),
                                    _switchTile(
                                      "Disable Auto-Play",
                                      "Prevent automatic video transmission",
                                      _disableAutoPlayVideos,
                                      (v) => setState(
                                        () => _disableAutoPlayVideos = v,
                                      ),
                                    ),
                                  ]),
