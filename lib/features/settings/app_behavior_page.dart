                              ...
                              child: Column(
                                children: [
                                  ...
                                  _buildSector("Interaction Intelligence", [
                                    _switchTile(
                                      "Auto-Play Media",
                                      "Automatic transmission of visual content",
                                      _autoPlayMedia,
                                      (v) => setState(() => _autoPlayMedia = v),
                                    ),
                                    _switchTile(
                                      "Data Saving Mode",
                                      ...
                                      _dataSaverEnabled,
                                      (v) =>
                                          setState(() => _dataSaverEnabled = v),
                                    ),
                                    _switchTile(
                                      "Background Refresh",
                                      "Real-time sync when identity is idle",
                                      _backgroundRefreshEnabled,
                                      (v) => setState(
                                        () => _backgroundRefreshEnabled = v,
                                      ),
                                    ),
                                    _switchTile(
                                      "System Guidance",
                                      "Show tips and platform tutorials",
                                      _showTipsEnabled,
                                      (v) =>
                                          setState(() => _showTipsEnabled = v),
                                    ),
                                  ]),
