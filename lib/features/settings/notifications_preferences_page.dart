                            ...
                            child: Column(
                              children: [
                                ...
                                _buildSector("Content Intelligence", [
                                  ...
                                  _switchTile(
                                    "Daily Devotionals",
                                    "Morning and evening spiritual insights",
                                    _devotionalsUpdates,
                                    (v) =>
                                        setState(() => _devotionalsUpdates = v),
                                  ),
                                  _switchTile(
                                    "Matchmaking",
                                    "Identity connection suggestions",
                                    _matchmakingUpdates,
                                    (v) =>
                                        setState(() => _matchmakingUpdates = v),
                                  ),
                                ]),
