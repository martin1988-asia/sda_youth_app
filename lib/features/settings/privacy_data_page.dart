  ...
  Future<void> _purgeHistory(bool deleteAll) async {
    ...
    try {
      ...
      if (mounted) {
        setState(() => _loading = false);
        _showFeedback(
          deleteAll ? "All Identity Data Purged" : "History Cleared",
        );
      }
    } catch (e) {
      if (mounted) setState(() => _loading = false);
  ...
  Future<bool?> _showConfirmDialog(bool isFullDelete) {
    return showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(
          isFullDelete ? "PURGE ALL DATA?" : "CLEAR HISTORY?",
          style: const TextStyle(
            color: Colors.white,
            fontWeight: FontWeight.bold,
          ),
                              ...
                              children: [
                                ...
                                _buildSector("Intelligence Sharing", [
                                  _switchTile(
                                    ...
                                    _shareDataEnabled,
                                    (v) =>
                                        setState(() => _shareDataEnabled = v),
                                  ),
                                  _switchTile(
                                    "Usage Analytics",
                                    "Help us measure mission impact",
                                    _analyticsEnabled,
                                    (v) =>
                                  ...
                                  _switchTile(
                                    "Relevant Content",
                                    "Personalized Bible & Event insights",
                                    _personalizedAdsEnabled,
                                    (v) => setState(
                                      () => _personalizedAdsEnabled = v,
                                    ),
                                  ),
                                ]),
                                ...
                                _buildSector("Data Governance", [
                                  _actionTile(
                                    ...
                                    "Purge your post and feedback history",
                                    Icons.history,
                                    Colors.orangeAccent,
                                    () => _purgeHistory(false),
                                  ),
                                  _actionTile(
                                    ...
                                    "Request a portable copy of your record",
      ...
      child: Column(
        ...
        children: [
          ...
          _actionTile(
            ...
            "Permanently delete all community data",
