...
class _EventsPageState extends State<EventsPage> {
  ...
  Widget _buildEventCard(QueryDocumentSnapshot<Map<String, dynamic>> doc) {
    ...
    final bool isOrganizer =
        data['organizerId'] == FirebaseAuth.instance.currentUser?.uid;
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildOrganizerSign(
                      data['organizerName'] ?? 'Mission Leader',
                      data['organizerPhoto'],
                    ),
                    const SizedBox(height: 12),
                    _buildCountdown(date),
                  ],
                ),
              ),
            ],
            ...
            children: [
              ...
              if (isOrganizer)
                IconButton(
                  ...
                  onPressed: () => EventService.purgeEvent(doc.id),
                ),
            ],
          ),
        ],
  ...
  /// Countdown widget showing days/hours left until mission date
  Widget _buildCountdown(DateTime eventDate) {
    ...
    if (difference.inDays > 0) {
      text = "${difference.inDays} day${difference.inDays > 1 ? 's' : ''} left";
  ...
  Widget _buildEmptyState() {
    return const SliverFillRemaining(
      ...
      child: Center(
        child: Text(
          "No missions scheduled on the horizon.",
    ...
    return StreamBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        return ElevatedButton(
          ...
          child: Text(
            isJoining ? "ON MISSION" : "JOIN MISSION",
            style: const TextStyle(
              fontWeight: FontWeight.w900,
              fontSize: 10,
              letterSpacing: 1,
