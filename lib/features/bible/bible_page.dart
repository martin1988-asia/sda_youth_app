      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              setState(
                () => _selectedTranslation = _selectedTranslation == 'kjv'
                    ? 'osh'
                    : 'kjv',
              );
              _showFeedback(
                "Translation: ${_selectedTranslation.toUpperCase()}",
              );
            },
          ),
        ],
  ...
  Widget _buildVerseStream() {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          stream: BibleService.getMarkersStream(
            _selectedBook,
            _selectedChapter,
          ),
          builder: (context, markerSnap) {
            ...
            final markedVerses =
                markerSnap.data?.docs
                    .map((m) => m.data()['verse'] as int)
                    .toSet() ??
                {};
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onLongPress: () {
                    ...
                    _showFeedback(
                      isMarked ? "Marker Removed" : "Sacred Marker Set",
                    );
                  },
                  child: Padding(
