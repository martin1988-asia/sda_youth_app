...
class _AnnouncementsPageState extends State<AnnouncementsPage> {
  ...
  Future<void> _checkClearance() async {
    ...
    if (mounted) {
      setState(
        () => _isAdmin = (role == UserRole.admin || role == UserRole.moderator),
      );
    }
  }
              ...
              child: ConstrainedBox(
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    ...
                    if (_isAdmin)
                      SliverToBoxAdapter(child: _AdminBroadcastPanel()),
              ...
              return Padding(
                ...
                child: ChoiceChip(
                  ...
                  labelStyle: TextStyle(
                    color: isSel ? Colors.black : Colors.white38,
                    fontSize: 9,
