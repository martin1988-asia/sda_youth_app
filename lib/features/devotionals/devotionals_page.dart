...
class _DevotionalsPageState extends State<DevotionalsPage> {
  ...
  Future<void> _checkPermissions() async {
    ...
    if (mounted) {
      setState(
        () => _isAdmin = (role.name == 'admin' || role.name == 'editor'),
      );
    }
  }
              ...
              child: ConstrainedBox(
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    _buildAppBar(),
                    if (_isAdmin)
                      SliverToBoxAdapter(child: _buildAdminComposer()),
                    _buildMannaStream(),
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                ts != null
                    ? timeago.format(ts.toDate()).toUpperCase()
                    : "RECENT",
                style: const TextStyle(
                  color: electricTeal,
                  fontSize: 9,
      ...
      builder: (context, snapshot) {
        ...
        return IconButton(
          icon: Icon(
            ...
            color: isFav ? const Color(0xFFFFCC00) : Colors.white10,
          ),
          onPressed: () =>
              DevotionalService.toggleFavorite(devotionalId, title),
        );
      },
    );
  }
...
class _ReflectionEngineState extends State<_ReflectionEngine> {
  ...
  Future<void> _submitReflection() async {
    ...
    await DevotionalService.transmitReflection(
