...
class _LearningPageState extends State<LearningPage> {
  ...
  Widget build(BuildContext context) {
    final user = FirebaseAuth.instance.currentUser;
    if (user == null)
      return const Scaffold(body: Center(child: Text("Verification Required")));
                      ...
                      builder: (context, snapshot) {
                        ...
                        return SliverList(
                          delegate: SliverChildBuilderDelegate(
                            (context, index) =>
                                _buildCourseCard(docs[index], user.uid),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Expand your mission through structured study.",
                  style: TextStyle(
  ...
  Widget _buildCourseCard(
    ...
    final desc = (data['description'] ?? 'No track metadata available.')
        .toString();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (enrolled)
                      ...
                      _buildEnrollButton(doc.id, title),
                  ],
                ),
              ),
...
class _QuizStudioState extends State<_QuizStudio> {
  ...
  Future<void> _submitAssessment() async {
    ...
    int score = (text == "genesis")
        ? 20
        : 5; // Logic matched to your original version
    final user = FirebaseAuth.instance.currentUser;
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Knowledge Verified: Progress Updated")),
      );
    }
  }
