  ...
  Future<void> _deleteItem(String docId) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          "Permanently delete this asset from $_selectedSector?",
    ...
    if (confirmed == true) {
      try {
        ...
        FirebaseAnalytics.instance.logEvent(
          name: 'admin_content_deleted',
          parameters: {'sector': _selectedSector},
        );
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text("Asset Purged: $_selectedSector"),
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: ChoiceChip(
              ...
              selected: isSelected,
              onSelected: (val) =>
                  setState(() => _selectedSector = sector['id']),
              avatar: Icon(
                sector['icon'],
                color: isSelected ? Colors.black : electricTeal,
                size: 16,
              ),
              ...
              showCheckmark: false,
              side: BorderSide(
                color: isSelected ? electricTeal : Colors.white10,
              ),
            ),
          );
        },
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            "No items in ${_selectedSector.toUpperCase()}",
            style: const TextStyle(
