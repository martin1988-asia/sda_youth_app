...
class _SignupPageState extends State<SignupPage> {
  ...
  final TextEditingController _churchPositionController =
      TextEditingController();
  ...
  final List<String> conferences = const [
    'Southern Conference',
    'Northern Conference',
  ];
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        Hero(
                          tag: 'app_logo',
                          child: Image.asset('assets/sda_logo.png', height: 80),
                        ),
                        ...
                        const Text(
                          "Strict Security • Kingdom Focused",
                          style: TextStyle(
                            color: electricTeal,
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
                        ...
                        _buildSection("Church Connection", [
                          ...
                          _buildDropdown(
                            ...
                            conferences,
                            _selectedConference,
                            (v) => setState(() => _selectedConference = v),
                            required: true,
                          ),
                          _buildDropdown(
                            "LOCAL CHURCH",
                            churchesByRegion[_selectedRegion] ?? [],
                            _selectedChurch,
                            (v) => setState(() => _selectedChurch = v),
                            required: true,
                          ),
                          _buildField(
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        validator:
            validator ??
            (v) =>
                required && (v == null || v.isEmpty) ? "Field Required" : null,
