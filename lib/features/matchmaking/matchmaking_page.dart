  ...
  Future<void> _handleConnect(String targetUid, String targetName) async {
    ...
    try {
      ...
      final String verifiedName =
          myDoc.data()?['name'] ?? user.displayName ?? 'Mission Member';
                                ...
                                children: [
                                  ...
                                  _buildSector("Connection Protocols", [
                                    _switchTile(
                                      ...
                                      "Find or become a mission leader",
                                      _mentorshipOptIn,
                                      (v) =>
                                          setState(() => _mentorshipOptIn = v),
                                    ),
                                    _switchTile(
                                      "Peer Friendship",
                                      "Connect with SDA youth peers",
                                      _friendshipOptIn,
                                      (v) =>
                                          setState(() => _friendshipOptIn = v),
                                    ),
                                    const SizedBox(height: 16),
                                    _inputField(
                                      "Interest Keywords",
                                      "e.g. Bible Study, Evangelism",
                                      _interestController,
                                    ),
  ...
  Widget _buildMatchCard(QueryDocumentSnapshot<Map<String, dynamic>> doc) {
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, userSnap) {
        ...
        final name =
            userData?['name'] ?? data['displayName'] ?? 'Identity Hidden';
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [primaryTeal, electricTeal.withValues(alpha: 0.5)],
                  ),
                ),
                child: CircleAvatar(
                  radius: 26,
