...
class BibleService {
  ...
  static Future<List<Map<String, dynamic>>> getChapterVerses(
    String bookId,
    int chapterNum,
  ) async {
    try {
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> getMarkersStream(
    String bookName,
    int chapter,
  ) {
    final user = FirebaseAuth.instance.currentUser;
  ...
  static Future<List<Map<String, dynamic>>> searchScripture(
    String query,
  ) async {
