...
class RoleService {
  ...
  static Future<UserRole> getAuthorizedRole() async {
    if (_activeRoleCache != null) {
      return _activeRoleCache!;
    }
  ...
  static bool isElder() => _activeRoleCache == UserRole.elder;
  static bool isLeader() => _activeRoleCache == UserRole.leader;
